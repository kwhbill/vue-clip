module.exports = {
    ...
    "rules": {
        ...
        // //    [1, "multi", "consistent"] 保持前后语句的{ }一致
        // //    default: [1, "all"] 全都需要{ }包围
        // "curly": [1, "all"],
        ...
        // //                          false 使用保留字做属性名时, 只能使用[]方式取属性 e.g [1, {"allowKeywords": false}]
        // //           allowPattern:  当属性名匹配提供的正则表达式时，允许使用[]方式取值,否则只能用.号取值 e.g [1, {"allowPattern": "^[a-z]+(_[a-z]+)+$"}]
